<?php
	...
	// if true, you need to fill password for reading pages too before setting to true,
	// read http://lionwiki.0o.cz/index.php?page=UserGuide%3A+How+to+use+PROTECTED_READ
